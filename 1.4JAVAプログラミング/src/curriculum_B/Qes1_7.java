...
public class Qes1_7 {
	...
	public static void main(String[] args) {
		...
		System.out.println(subject[0] + "の平均点は" + (String.format("%.2f", aveE.getAverage())) + "点です。" + "\n");
		...
		System.out.println(subject[1] + "の平均点は" + (String.format("%.2f", aveS.getAverage())) + "点です。" + "\n");
		...
		System.out.println(subject[2] + "の平均点は" + (String.format("%.2f", aveR.getAverage())) + "点です。" + "\n");
		...
		System.out.println(subject[3] + "の平均点は" + (String.format("%.2f", aveY.getAverage())) + "点です。" + "\n");
		System.out.println();
